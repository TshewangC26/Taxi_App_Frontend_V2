...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  void _onNavTap(int index) {
    ...
    if (index == 1) {
      Navigator.pushReplacement(context, PageRouteBuilder(
        pageBuilder: (_, animation, __) => FadeTransition(
            opacity: animation, child: const BookRideScreen()),
        transitionDuration: const Duration(milliseconds: 300),
      ));
      return;
    }
    if (index == 2) {
      Navigator.pushReplacement(context, PageRouteBuilder(
        pageBuilder: (_, animation, __) => FadeTransition(
            opacity: animation, child: const MyBookingsScreen()),
        transitionDuration: const Duration(milliseconds: 300),
      ));
      return;
    }
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Column(children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(20),
                              border: Border.all(color: _getUserTypeColor(user.userType).withOpacity(0.4)),
                            ),
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              Icon(Icons.verified_user_outlined, size: 13, color: _getUserTypeColor(user.userType)),
                              const SizedBox(width: 5),
                              Text(
                                user.userType[0].toUpperCase() + user.userType.substring(1),
                                style: TextStyle(color: _getUserTypeColor(user.userType), fontWeight: FontWeight.w700, fontSize: 13),
                              ),
                            ]),
                          ),
                        ]),
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          _buildInfoRow(icon: Icons.mail_outline_rounded, label: 'Email', value: user.email, isFirst: true),
                          Divider(height: 1, indent: 56, color: Colors.grey.shade100),
                          _buildInfoRow(icon: Icons.phone_outlined, label: 'Phone', value: user.phone ?? 'Not provided', isFirst: false),
                        ]),
                      ),
  ...
  Widget _buildInfoRow({required IconData icon, required String label, required String value, required bool isFirst}) {
    return Padding(
      padding: EdgeInsets.only(left: 16, right: 16, top: isFirst ? 16 : 12, bottom: isFirst ? 12 : 16),
      child: Row(children: [
  ...
  Widget _buildActionRow({
    ...
    return InkWell(
      ...
      child: Padding(
        padding: EdgeInsets.only(left: 16, right: 16, top: isFirst ? 16 : 12, bottom: isLast ? 16 : 12),
        child: Row(children: [
          Container(width: 40, height: 40,
