...
class _DriverHomeScreenState extends State<DriverHomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final totalPending   = driverProvider.nowBookings.length +
        driverProvider.scheduledBookings.length;
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '$totalPending pending booking${totalPending > 1 ? 's' : ''}',
                                  style: TextStyle(
                ...
                // Row 1: Available Rides + My Rides + Earnings
                Row(children: [
                  Expanded(
                    child: _ActionCard(
                ...
                Row(children: [
                  Expanded(
                    child: _ActionCard(
                      ...
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                const DriverPaymentDetailsScreen()),
                      ),
                    ),
                  ),
                  const SizedBox(width: 12),
                  ...
                  // Empty spacer to keep row aligned
