...
class _BookRideScreenState extends State<BookRideScreen>
  ...
  Future<void> _getPassengerLocation() async {
    ...
    try {
      ...
      // ✅ Get last known position FAST first — shows map instantly
      Position? lastPosition = await Geolocator.getLastKnownPosition();
      if (lastPosition != null && mounted) {
        setState(() {
          _passengerLat    = lastPosition.latitude;
          _passengerLng    = lastPosition.longitude;
          _locationLoading = false;
        });
        ...
        _updateMapMarkers();
        if (_vehicleType != null) _loadNearbyDriversFromFirebase();
      }

      // ✅ Then get fresh position in background
                      ...
                      children: [
                          ...
                          onChanged: (v) {
                            ...
                            if (_passengerLat != null && _passengerLng != null) {
                              ...
                              Future.delayed(const Duration(seconds: 3), () {
                                if (mounted) _loadNearbyDriversFromFirebase();
                              });
                            }
                          },
                        ),
                        ...
                        if (_vehicleType != null) ...[
                          Row(
                            ...
                            children: [
                              _SectionLabel(title: 'Nearby Drivers ($_vehicleType)'),
                              Row(children: [
                              ...
                              : _availableDrivers.isEmpty
                                  ? Container(
                                      ...
                                      child: Column(children: [
                                        ...
                                        const SizedBox(height: 10),
                                        Text('No drivers available within 3km',
                                            style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey[500], fontSize: 14)),
                                        const SizedBox(height: 4),
                                        Text('Waiting for nearby drivers...', style: TextStyle(fontSize: 12, color: Colors.grey[400])),
                                      ]),
                                    )
                                  : ListView.builder(
                                      shrinkWrap: true,
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            ...
                                            _mapController?.animateCamera(
                                              CameraUpdate.newLatLng(LatLng(driver['latitude'] as double, driver['longitude'] as double)),
                                            );
                                          },
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              borderRadius: BorderRadius.circular(16),
                                              border: Border.all(
                                                color: isSelected ? Colors.yellow[700]! : Colors.grey.shade100,
                                            ...
                                            child: Row(children: [
                                              Container(
                                                ...
                                                child: Icon(Icons.person_rounded,
                                                    color: isSelected ? Colors.yellow[800] : Colors.grey[500], size: 26),
                                              ),
                                              const SizedBox(width: 12),
                                              Expanded(
                                                child: Column(
                        ...
                        Row(children: [
                          ...
                          Expanded(
                            child: _BookingTypeCard(
                              ...
                              onTap: () => setState(() => _bookingType = 'scheduled'),
                            ),
                          ),
                        ]),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: const Text('Calculate Price', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                            style: ElevatedButton.styleFrom(
                        ...
                        if (_priceCalculated && _estimatedPrice != null) ...[
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(color: Colors.yellow[50], borderRadius: BorderRadius.circular(14)),
                                  child: Icon(Icons.attach_money_rounded, color: Colors.yellow[800], size: 28),
                                ),
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Estimated Price', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                                      Text('Nu. $_estimatedPrice',
                                          style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: Colors.yellow[800])),
                                      Text('$_pickupLocation  →  $_dropoffLocation',
