                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        _InfoSection(
                          children: [
                            _InfoRow(
                              ...
                              label: 'Vehicle Type',
                              value: profile['vehicle_type']?.toString() ??
                                  'Not set',
                              isFirst: true,
                            ),
                            Divider(height: 1, indent: 56,
                      ...
                      if (profile != null &&
                        ...
                        _InfoSection(
                          children: [
                            if ((profile['account_number']?.toString() ?? '')
                                .isNotEmpty) ...[
                              _InfoRow(
                            ...
                            if ((profile['mobile_payment_number']
                                        ?.toString() ??
                                    '')
                                .isNotEmpty) ...[
                              _InfoRow(
                                ...
                                value: profile['mobile_payment_number']
                                    .toString(),
                                isFirst: (profile['account_number']
                                            ?.toString() ??
                                        '')
                                    .isEmpty,
                              ),
...
class _ActionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        padding: EdgeInsets.fromLTRB(16, isFirst ? 16 : 12, 16,
            isLast ? 16 : 12),
        child: Row(children: [
          Container(
            width: 40, height: 40,
