...
class _DriverMyRidesScreenState extends State<DriverMyRidesScreen>
  ...
  // ── Only scheduled rides, active first ───────────────────────
  List<dynamic> _sortedRides(List<dynamic> rides) {
    final scheduled =
        rides.where((r) => r['booking_type'] == 'scheduled').toList();
    final active = scheduled
        .where((r) =>
            r['status'] == 'accepted' || r['status'] == 'in_progress')
        .toList();
    final completed =
        scheduled.where((r) => r['status'] == 'completed').toList();
      ...
      case 1:
        Navigator.pushReplacement(context, PageRouteBuilder(
          pageBuilder: (_, a, __) => FadeTransition(
              opacity: a, child: const DriverAvailableRidesScreen()),
          transitionDuration: const Duration(milliseconds: 300),
        ));
        break;
      case 3:
        Navigator.pushReplacement(context, PageRouteBuilder(
          pageBuilder: (_, a, __) =>
              FadeTransition(opacity: a, child: const DriverEarningsScreen()),
          transitionDuration: const Duration(milliseconds: 300),
        ));
        break;
      case 4:
        Navigator.pushReplacement(context, PageRouteBuilder(
          pageBuilder: (_, a, __) =>
              FadeTransition(opacity: a, child: const DriverProfileScreen()),
          transitionDuration: const Duration(milliseconds: 300),
        ));
        break;
    }
  ...
  bool _isTimeToStart(dynamic booking) {
    try {
      ...
      final scheduledDateTime =
          DateTime.parse(dateStr).copyWith(hour: hour, minute: minute);
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('Nu. $amount',
                  style: TextStyle(fontSize: 32,
                      fontWeight: FontWeight.w800, color: Colors.yellow[800])),
  ...
  Future<void> _deleteRide(
      BuildContext context, dynamic booking, DriverProvider dp) async {
    final confirmed = await showDialog<bool>(
      context: context,
      barrierColor: Colors.black.withOpacity(0.5),
      builder: (ctx) => Dialog(
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          _buildRideCard(context, sortedRides[index], dp),
                    ),
                  ),
                ),
    );
  ...
  Widget _buildRideCard(
    ...
    final passengerName =
        passenger?['name'] ?? booking['passenger_name'] ?? 'Passenger';
          ...
          children: [
                ...
                child: Row(children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          timeArrived ? 'Time to start the ride!' : 'Scheduled for',
                          style: TextStyle(
                            color: timeArrived
                                ? const Color(0xFF2E7D32)
                                : const Color(0xFF5E35B1),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Nu. ${booking['final_price'] ?? booking['estimated_price'] ?? '0'}',
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w800,
                      color: Colors.yellow[800]),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('Start button appears at ride time',
                          style: TextStyle(
                              color: Colors.grey[500],
                              fontSize: 13,
                              fontWeight: FontWeight.w500)),
            ...
            if (status == 'in_progress')
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () =>
                      _showCompleteConfirmation(context, booking, dp),
